...
namespace Management_Coffee_Shop
{
    ...
    {
        public static Dictionary<string,(int,int,Boolean)> list_products=new Dictionary<string, (int,int,Boolean)>();
        ...
        {
            string apiKey = "WxT7Wuy87UD0l388s99ils0VIinvE9R07DaRZE694b4"; // Thay bằng API Key của bạn
            string origin = change_Coordinates(address);  // Tọa độ điểm xuất phát (TPHCM)
            string destination = change_Coordinates("3 Đ. Hòa Bình, Phường 3, Quận 11, Hồ Chí Minh 70000, Việt Nam"); // Tọa độ điểm đến (Hà Nội)
